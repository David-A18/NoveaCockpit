...
- `docs/publication-policy.md`: public/private repository boundary.
- `sample-gui/`: static fake-data GUI preview.
- `sample-gui/images/`: public screenshots approved for sharing.
